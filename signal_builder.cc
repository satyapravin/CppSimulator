...
#define NORMALIZE(struct_name, mean_name, ssr_name, property_name, alpha) \
    do { \
...
double fill_price(const std::vector<double>& bid_prices, const std::vector<double>& bid_sizes, double size) {
    ...
    for(auto ii = 0; ii < bid_prices.size(); ++ii) {
        ...
        fill_amount += std::min(bid_sizes[ii], fill_size);
...
void SignalBuilder::normalize_spread_signals() {
    ...
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_bid_spread_signal_0, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_bid_spread_signal_1, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_bid_spread_signal_2, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_bid_spread_signal_3, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_bid_spread_signal_4, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_ask_spread_signal_0, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_ask_spread_signal_1, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_ask_spread_signal_2, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_ask_spread_signal_3, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, norm_vwap_ask_spread_signal_4, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, micro_spread_signal_0, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, micro_spread_signal_1, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, micro_spread_signal_2, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, micro_spread_signal_3, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, micro_spread_signal_4, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, bid_fill_spread_signal_0, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, bid_fill_spread_signal_1, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, bid_fill_spread_signal_2, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, bid_fill_spread_signal_3, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, bid_fill_spread_signal_4, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, ask_fill_spread_signal_0, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, ask_fill_spread_signal_1, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, ask_fill_spread_signal_2, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, ask_fill_spread_signal_3, norm_alpha);
    NORMALIZE(spread_signal, raw_spread_signal_mean, raw_spread_signal_ssqr, ask_fill_spread_signal_4, norm_alpha);
}

void SignalBuilder::normalize_price_signals() {
    auto price_signal = raw_price_signals.get(0);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, mid_price_signal, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_bid_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_bid_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_bid_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_bid_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_bid_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_ask_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_ask_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_ask_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_ask_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, vwap_ask_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_bid_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_bid_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_bid_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_bid_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_bid_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_ask_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_ask_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_ask_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_ask_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, norm_vwap_ask_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, micro_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, micro_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, micro_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, micro_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, micro_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, bid_fill_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, bid_fill_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, bid_fill_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, bid_fill_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, bid_fill_price_signal_4, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, ask_fill_price_signal_0, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, ask_fill_price_signal_1, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, ask_fill_price_signal_2, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, ask_fill_price_signal_3, norm_alpha);
    NORMALIZE(price_signal, raw_price_signal_mean, raw_price_signal_ssqr, ask_fill_price_signal_4, norm_alpha);
}
...
void SignalBuilder::compute_price_signals(price_signal_repository& raw_price_repo,
    ...
    raw_price_repo.vwap_bid_price_signal_0 = cum_bid_amounts[1] / cum_bid_sizes[1];
    raw_price_repo.vwap_bid_price_signal_0 = cum_bid_amounts[2] / cum_bid_sizes[2];
    raw_price_repo.vwap_bid_price_signal_0 = cum_bid_amounts[3] / cum_bid_sizes[3];
    raw_price_repo.vwap_bid_price_signal_0 = cum_bid_amounts[4] / cum_bid_sizes[4];

    raw_price_repo.vwap_ask_price_signal_0 = cum_ask_amounts[0] / cum_ask_sizes[0];
    raw_price_repo.vwap_ask_price_signal_0 = cum_ask_amounts[1] / cum_ask_sizes[1];
    raw_price_repo.vwap_ask_price_signal_0 = cum_ask_amounts[2] / cum_ask_sizes[2];
    raw_price_repo.vwap_ask_price_signal_0 = cum_ask_amounts[3] / cum_ask_sizes[3];
    raw_price_repo.vwap_ask_price_signal_0 = cum_ask_amounts[4] / cum_ask_sizes[4];
    ...
    raw_price_repo.bid_fill_price_signal_0 = fill_price(current_bid_prices, current_ask_sizes, 0);
    raw_price_repo.bid_fill_price_signal_1 = fill_price(current_bid_prices, current_ask_sizes, 1);
    raw_price_repo.bid_fill_price_signal_2 = fill_price(current_bid_prices, current_ask_sizes, 2);
    raw_price_repo.bid_fill_price_signal_3 = fill_price(current_bid_prices, current_ask_sizes, 3);
    raw_price_repo.bid_fill_price_signal_4 = fill_price(current_bid_prices, current_ask_sizes, 4);

    raw_price_repo.ask_fill_price_signal_0 = fill_price(current_ask_prices, current_bid_sizes, 0);
    raw_price_repo.ask_fill_price_signal_1 = fill_price(current_ask_prices, current_bid_sizes, 1);
    raw_price_repo.ask_fill_price_signal_2 = fill_price(current_ask_prices, current_bid_sizes, 2);
    raw_price_repo.ask_fill_price_signal_3 = fill_price(current_ask_prices, current_bid_sizes, 3);
    raw_price_repo.ask_fill_price_signal_4 = fill_price(current_ask_prices, current_bid_sizes, 4);
}
